...
export default {
  ...
  methods: {
    fetchAppointments() {
      fetch("https://t41c3rg9wd.execute-api.us-east-1.amazonaws.com/prod/appointments")
        .then(res => res.json())
        .then(data => {
    ...
    updateStatus(appointment, newStatus) {
      ...
      const url = `https://t41c3rg9wd.execute-api.us-east-1.amazonaws.com/prod/appointments/${appointment.appointmentId}`;
